...
// Placeholder images
const clubImages = [
  'https://placehold.co/800x450/97437f/white?text=Outreach+Club+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Outreach+Club+Image+2',
  'https://placehold.co/800x450/723261/white?text=Outreach+Club+Image+3',
];

const eventImages = [
  'https://placehold.co/800x450/97437f/white?text=PR+Summit+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=PR+Summit+Image+2',
  'https://placehold.co/800x450/723261/white?text=PR+Summit+Image+3',
];
...
const positionHolders: ClubPositionHolder[] = [
  {
    position: 'Secretary',
    name: 'Lorem Ipsum',
    email: 'secretary.outreach@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec1.outreach@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec2.outreach@example.com'
  }
];
