...
// Placeholder images
const clubImages = [
  'https://placehold.co/800x450/97437f/white?text=Astronomy+Club+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Astronomy+Club+Image+2',
  'https://placehold.co/800x450/723261/white?text=Astronomy+Club+Image+3',
];

const eventImages = [
  'https://placehold.co/800x450/97437f/white?text=Star+Gazing+Night+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Star+Gazing+Night+Image+2',
  'https://placehold.co/800x450/723261/white?text=Star+Gazing+Night+Image+3',
];
...
const positionHolders: ClubPositionHolder[] = [
  {
    position: 'Secretary',
    name: 'Lorem Ipsum',
    email: 'secretary.astronomy@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec1.astronomy@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec2.astronomy@example.com'
  }
];
