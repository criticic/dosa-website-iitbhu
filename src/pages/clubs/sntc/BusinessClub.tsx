...
// Placeholder images
const clubImages = [
  'https://placehold.co/800x450/97437f/white?text=Business+Club+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Business+Club+Image+2',
  'https://placehold.co/800x450/723261/white?text=Business+Club+Image+3',
];

const eventImages = [
  'https://placehold.co/800x450/97437f/white?text=Business+Summit+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Business+Summit+Image+2',
  'https://placehold.co/800x450/723261/white?text=Business+Summit+Image+3',
];
...
const positionHolders: ClubPositionHolder[] = [
  {
    position: 'Secretary',
    name: 'Lorem Ipsum',
    email: 'secretary.business@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec1.business@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec2.business@example.com'
  }
];
