...
// Placeholder images
const clubImages = [
  'https://placehold.co/800x450/97437f/white?text=Aquatics+Club+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Aquatics+Club+Image+2',
  'https://placehold.co/800x450/723261/white?text=Aquatics+Club+Image+3',
];

const eventImages = [
  'https://placehold.co/800x450/97437f/white?text=Swimming+Gala+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Swimming+Gala+Image+2',
  'https://placehold.co/800x450/723261/white?text=Swimming+Gala+Image+3',
];
...
const positionHolders: ClubPositionHolder[] = [
  {
    position: 'Secretary',
    name: 'Lorem Ipsum',
    email: 'secretary.aquatics@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec1.aquatics@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec2.aquatics@example.com'
  }
];
