...
// Placeholder images
const clubImages = [
  'https://placehold.co/800x450/97437f/white?text=Tennis+Club+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Tennis+Club+Image+2',
  'https://placehold.co/800x450/723261/white?text=Tennis+Club+Image+3',
];

const eventImages = [
  'https://placehold.co/800x450/97437f/white?text=Tennis+Tournament+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Tennis+Tournament+Image+2',
  'https://placehold.co/800x450/723261/white?text=Tennis+Tournament+Image+3',
];
...
const positionHolders: ClubPositionHolder[] = [
  {
    position: 'Secretary',
    name: 'Lorem Ipsum',
    email: 'secretary.tennis@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec1.tennis@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec2.tennis@example.com'
  }
];
