...
// Placeholder images
const clubImages = [
  'https://placehold.co/800x450/97437f/white?text=Badminton+Club+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Badminton+Club+Image+2',
  'https://placehold.co/800x450/723261/white?text=Badminton+Club+Image+3',
];

const eventImages = [
  'https://placehold.co/800x450/97437f/white?text=Badminton+Championship+Image+1',
  'https://placehold.co/800x450/833a6f/white?text=Badminton+Championship+Image+2',
  'https://placehold.co/800x450/723261/white?text=Badminton+Championship+Image+3',
];
...
const positionHolders: ClubPositionHolder[] = [
  {
    position: 'Secretary',
    name: 'Lorem Ipsum',
    email: 'secretary.badminton@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec1.badminton@example.com'
  },
  {
    position: 'Joint Secretary',
    name: 'Lorem Ipsum',
    email: 'jointsec2.badminton@example.com'
  }
];
